...
class iotMQTT:
    ...
    def postDataFeed(c,dt,did):
        ...
        dt["deviceId"]= did
        dtStr = json.dumps(dt)
            # c.client.publish("iot.server.datafeed.topic",dtStr)                             #tapas
        c.client.publish("topic123",dtStr) 
    ...
    def __init__(self):
        ...
        self.subscriptionId = "143"            
        self.client = mqtt.Client("mqtt") #create new instance
        self.client.subscriptionId = self.subscriptionId
        self.client.accountId = "123"
